...
| 二期功能 | 《二期功能/乘客端_个人中心_我的订单_PRD.md》《二期功能/乘客端_个人中心_我的订单_TECH.md》《二期功能/乘客端_个人中心_我的订单_API.md》《二期功能/乘客端_个人中心_我的订单_TEST.md》 |
...
| **P0（必须讨论）** | **优惠券后收入分配口径** | 我的钱包二期引入优惠券后，`final_amount`、优惠抵扣、`payable_amount`、平台收入、司机/车队结算收入之间会出现分摊口径问题。虽然本期暂不展开讨论，但这是金额问题，**绝对不能忘记在开发结算/支付闭环前单独讨论并定版**。 | 明确优惠券成本承担方（平台/司机/车队/活动预算）、司机收入按优惠前还是优惠后计算、车队/平台分账基数、发票/退款/对账展示口径；必要时补结算明细表或收入分摊快照。 | 在免密支付/优惠券进入真实扣款与结算前，产出明确文档并更新 PRD/TECH/API；没有该口径不得上线真实金额闭环。 |
