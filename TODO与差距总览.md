...
| 后台（汇总） | 《后台管理系统_权限清单与鉴权设计.md》《后台管理系统_权限与接口文档.md》《后台管理系统_订单管理_PRD.md》《后台管理系统_订单管理_TECH.md》《后台管理系统_订单管理_API.md》《后台管理系统_运力配置_PRD.md》《后台管理系统_运力配置_TECH.md》《后台管理系统_运力配置_API.md》《后台管理系统_计价管理_PRD.md》《后台管理系统_计价管理_TECH.md》《后台管理系统_计价管理_API.md》 |
| 订单技术 | 《订单与派单_订单服务幂等与并发方案说明.md》《订单与派单_两段式Outbox与Kafka_技术方案.md》 |
| 二期功能 | 《二期功能/README.md》《二期功能/乘客端_个人中心_我的订单_PRD.md》《二期功能/乘客端_个人中心_我的订单_TECH.md》《二期功能/乘客端_个人中心_我的订单_API.md》《二期功能/乘客端_个人中心_我的订单_TEST.md》《二期功能/乘客端_个人中心_设置_PRD.md》《二期功能/乘客端_个人中心_设置_TECH.md》《二期功能/乘客端_个人中心_设置_API.md》《二期功能/乘客端_个人中心_设置_TEST.md》《二期功能/乘客端_个人中心_我的钱包_免密支付与优惠券_PRD.md》《二期功能/乘客端_个人中心_我的钱包_免密支付与优惠券_TECH.md》《二期功能/乘客端_个人中心_我的钱包_免密支付与优惠券_API.md》《二期功能/乘客端_个人中心_我的钱包_免密支付与优惠券_TEST.md》《二期功能/车队营销优惠券_PRD.md》《二期功能/车队营销优惠券_TECH.md》《二期功能/车队营销优惠券_API.md》《二期功能/车队营销优惠券_SQL.md》 |
...
| **高** | **车队营销优惠券后台实现** | 文档已定：从计价规则详情查看同范围优惠券方案，SUPER 独占创建/发布/下架，非 SUPER 只读；代码尚未实现后台页面与 admin-api 聚合。 |
| **高** | **优惠券目标表结构迁移** | 现有钱包二期优惠券表仅支持简单固定减免，缺 `company_id`、折扣/封顶、领取上限、活动编码、规则快照、服务费结算字段；需按《二期功能/车队营销优惠券_SQL.md》迁移。 |
...
| **高** | **车队营销优惠券计算落地** | 现有优惠券代码仍偏简单固定金额券；需支持固定减免、比例折扣、封顶折扣、固定有效期、城市/产品线/最终承运 `company_id` 匹配、最优券排序和用券快照。 |
...
| **P0（已定核心口径，待实现）** | **车队营销优惠券与结算快照落地** | 核心口径已确认：不存在平台券，优惠成本由发券车队承担；平台服务费 = 乘客优惠后实付车费 * 5%；承运侧收入 = 乘客实付车费 - 平台服务费；本期不拆司机最终收入/车队收费。 | 按《车队营销优惠券》PRD/TECH/API/SQL 落地模板、领券、锁券、核销、退券、结算快照、后台只读/超管写权限；重点处理异步派单最终 `company_id` 与预估阶段不一致风险。 | 用例覆盖最终承运车队匹配、最优券、折扣/封顶、支付失败释放、全额退款退券、服务费和承运侧收入；未完成前不得上线真实金额闭环。 |
...
| 2026-07-05 | **新增金额风险必讨论项**：我的钱包二期优惠券会影响订单收入分配，虽暂不讨论方案，但在真实支付/结算闭环开发前必须单独定版优惠成本承担、司机/车队/平台分账、退款发票和对账口径。 |
| 2026-07-07 | **车队营销优惠券口径定版并拆文档**：已确认车队承担优惠成本、无平台券、平台服务费按优惠后实付 5%、`fare_rule` 不扩字段、优惠券按最终承运 `company_id` 校验；新增 PRD/TECH/API/SQL 并同步钱包、计价、权限、测试文档。 |
