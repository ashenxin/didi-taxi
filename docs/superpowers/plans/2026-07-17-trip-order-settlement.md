# Trip Order Settlement Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 实现司机完单后的异步最终计价、优惠券锁定、mock 免密/主动支付、结算查询和未结清订单拦截完整闭环。

**Architecture:** `order-service` 继续拥有订单和权威结算状态，并通过现有 Transactional Outbox 发布完单结算事件；同服务 Kafka 消费者幂等编排 `calculate-service` 与 `wallet-service`。`map-service` 和完单时长提供稳定、可复算且首次即冻结的本地 mock 输入。`wallet-service` 保存一单多次支付尝试并提供受环境限制的 mock 收银台；`passenger-api` 只做鉴权、聚合和页面入口，不决定金额或状态。

**Tech Stack:** Java 21、Spring Boot、Spring Kafka、OpenFeign、MyBatis-Plus、MySQL/H2、JUnit 5、Mockito、MockMvc
...
- 不修改或提交仓库根目录未跟踪文件 `乘客司机端_完单结算方案讨论.md`。

---

### Task 1: 固定本地 mock 路线与计价规则快照

**Files:**

- Create: `map/src/main/java/com/sx/map/service/MockRouteProvider.java`
- Create: `map/src/test/java/com/sx/map/service/MockRouteProviderTest.java`
- Modify: `map/src/main/java/com/sx/map/controller/RouteController.java`
- Modify: `map/src/main/java/com/sx/map/model/dto/RouteResponse.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/client/MapClient.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/model/map/RouteResponse.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/service/PassengerOrderService.java`
- Modify: `calculate/src/main/java/com/sx/calculate/model/dto/EstimateFareResult.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/model/calculate/EstimateFareResult.java`
...
git commit -m "feat: freeze deterministic mock route and fare snapshot"
```
...
- Modify: `order/src/main/java/com/sx/order/model/TripOrder.java`
- Modify: `order/src/main/java/com/sx/order/model/TripOrderSettlement.java`
- Modify: `order/src/main/java/com/sx/order/model/dto/CreateOrderBody.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/model/ordercore/CreateOrderBody.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/service/PassengerOrderService.java`
...
git commit -m "feat: persist frozen settlement inputs on trip orders"
```

---

### Task 3: 抽取最终计价器并严格校验金额

**Files:**

- Create: `calculate/src/main/java/com/sx/calculate/service/FareCalculator.java`
- Create: `calculate/src/main/java/com/sx/calculate/model/dto/FareRuleSnapshot.java`
- Create: `calculate/src/main/java/com/sx/calculate/model/dto/FinalFareRequest.java`
- Create: `calculate/src/main/java/com/sx/calculate/model/dto/FinalFareResult.java`
- Create: `calculate/src/test/java/com/sx/calculate/service/FareCalculatorTest.java`
- Modify: `calculate/src/main/java/com/sx/calculate/controller/EstimateController.java`
...
```bash
git add calculate
git commit -m "feat: add snapshot-based final fare calculation"
```

---

### Task 4: 完单原子登记结算任务且忽略客户端计价字段

**Files:**

- Modify: `order/src/main/java/com/sx/order/model/dto/FinishOrderBody.java`
- Modify: `driver-api/src/main/java/com/sx/driverapi/model/order/FinishOrderBody.java`
- Modify: `driver-api/src/main/java/com/sx/driverapi/service/DriverBffService.java`
- Modify: `order/src/main/java/com/sx/order/service/TripOrderWriteService.java`
...
git commit -m "feat: enqueue settlement atomically when trip finishes"
```

---

### Task 5: 建立 order-service 结算编排骨架与 mock 实际时长

**Files:**

- Create: `order/src/main/java/com/sx/order/service/MockTripMetricsProvider.java`
- Create: `order/src/main/java/com/sx/order/service/SettlementAmountValidator.java`
- Create: `order/src/main/java/com/sx/order/service/TripOrderSettlementService.java`
- Create: `order/src/main/java/com/sx/order/messaging/SettlementRequestedListener.java`
- Create: `order/src/main/java/com/sx/order/job/SettlementRecoveryJob.java`
- Create: `order/src/main/java/com/sx/order/client/CalculateSettlementClient.java`
- Create: `order/src/main/java/com/sx/order/client/WalletPaymentClient.java`
- Create: `order/src/main/java/com/sx/order/config/SettlementClientConfig.java`
- Create: `order/src/test/java/com/sx/order/service/TripOrderSettlementServiceTest.java`
- Modify: `order/src/main/java/com/sx/order/controller/TripOrderSettlementController.java`
...
```bash
git add order
git commit -m "feat: add idempotent settlement orchestration skeleton"
```

---

### Task 6: 完成计价、锁券、零元单和金额异常编排

**Files:**

- Modify: `order/src/main/java/com/sx/order/service/TripOrderSettlementService.java`
- Modify: `order/src/main/java/com/sx/order/service/SettlementAmountValidator.java`
- Modify: `order/src/main/java/com/sx/order/client/CalculateSettlementClient.java`
- Create: `order/src/main/java/com/sx/order/model/dto/FinalFareRequest.java`
- Create: `order/src/main/java/com/sx/order/model/dto/FinalFareResult.java`
- Create: `order/src/main/java/com/sx/order/model/dto/CouponLockRequest.java`
- Create: `order/src/main/java/com/sx/order/model/dto/CouponLockResult.java`
...
git commit -m "feat: finalize fare coupon and zero-payment settlements"
```

---

### Task 7: 将钱包支付单升级为一单多次尝试

**Files:**

- Modify: `wallet/src/main/resources/sql/wallet_schema.sql`
- Modify: `wallet/src/main/java/com/sx/wallet/model/WalletPaymentOrder.java`
- Create: `wallet/src/main/java/com/sx/wallet/model/dto/CreatePaymentAttemptRequest.java`
- Modify: `wallet/src/main/java/com/sx/wallet/model/dto/PaymentResult.java`
- Create: `wallet/src/main/java/com/sx/wallet/service/PaymentAttemptService.java`
- Create: `wallet/src/main/java/com/sx/wallet/service/PaymentChannel.java`
- Create: `wallet/src/main/java/com/sx/wallet/service/MockPaymentChannel.java`
...
```bash
git add wallet
git commit -m "feat: support auditable multi-attempt mock payments"
```

---

### Task 8: 实现安全 mock 收银台、回调和支付结果查询

**Files:**

- Create: `wallet/src/main/java/com/sx/wallet/config/MockPaymentProperties.java`
- Create: `wallet/src/main/java/com/sx/wallet/config/MockPaymentStartupValidator.java`
- Create: `wallet/src/main/java/com/sx/wallet/controller/MockCashierController.java`
- Create: `wallet/src/main/java/com/sx/wallet/model/dto/ResolveMockPaymentRequest.java`
- Modify: `wallet/src/main/java/com/sx/wallet/service/PaymentAttemptService.java`
- Modify: `wallet/src/main/resources/application.yml`
...
```bash
git add wallet
git commit -m "feat: add environment-gated mock cashier"
```

---

### Task 9: 接通免密支付状态与成功收尾

**Files:**

- Modify: `order/src/main/java/com/sx/order/service/TripOrderSettlementService.java`
- Modify: `order/src/main/java/com/sx/order/client/WalletPaymentClient.java`
- Create: `order/src/main/java/com/sx/order/model/dto/PaymentAttemptRequest.java`
- Create: `order/src/main/java/com/sx/order/model/dto/PaymentAttemptResult.java`
- Create: `order/src/main/java/com/sx/order/controller/SettlementPaymentResultController.java`
- Create: `order/src/main/java/com/sx/order/model/dto/PaymentResultNotification.java`
- Modify: `order/src/test/java/com/sx/order/service/TripOrderSettlementServiceTest.java`
- Modify: `wallet/src/main/java/com/sx/wallet/service/PaymentAttemptService.java`
- Create: `wallet/src/main/java/com/sx/wallet/client/OrderSettlementClient.java`
...
git commit -m "feat: finalize settlements from mock payment results"
```

---

### Task 10: 实现权威未结清拦截与结构化 409

**Files:**

- Create: `order/src/main/java/com/sx/order/common/exception/UnsettledOrderException.java`
- Create: `order/src/main/java/com/sx/order/model/dto/BlockingOrderResult.java`
- Modify: `order/src/main/java/com/sx/order/service/TripOrderWriteService.java`
- Modify: `order/src/main/java/com/sx/order/controller/TripOrderController.java`
- Modify: `order/src/main/java/com/sx/order/controller/TripOrderSettlementController.java`
- Create: `order/src/test/java/com/sx/order/service/UnsettledOrderGateTest.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/client/OrderClient.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/service/PassengerOrderService.java`
...
```bash
git add order passenger-api
git commit -m "feat: block booking while prior order is unsettled"
```

---

### Task 11: 暴露乘客结算查询与主动支付接口

**Files:**

- Create: `passenger-api/src/main/java/com/sx/passengerapi/model/settlement/SettlementDetailVO.java`
- Create: `passenger-api/src/main/java/com/sx/passengerapi/model/settlement/ManualPaymentRequest.java`
- Create: `passenger-api/src/main/java/com/sx/passengerapi/model/settlement/PaymentInvokeResult.java`
- Create: `passenger-api/src/main/java/com/sx/passengerapi/service/PassengerSettlementService.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/controller/PassengerOrderController.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/client/OrderClient.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/client/WalletClient.java`
- Create: `passenger-api/src/test/java/com/sx/passengerapi/controller/PassengerSettlementControllerTest.java`
- Modify: `order/src/main/java/com/sx/order/controller/TripOrderSettlementController.java`
...
git commit -m "feat: expose settlement query and manual payment APIs"
```

---

### Task 12: 在订单列表和详情展示结算摘要并发送刷新通知

**Files:**

- Modify: `passenger-api/src/main/java/com/sx/passengerapi/model/order/PassengerOrderListItemVO.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/model/order/PassengerOrderDetailVO.java`
- Modify: `passenger-api/src/main/java/com/sx/passengerapi/service/PassengerOrderService.java`
- Modify: `passenger-api/src/test/java/com/sx/passengerapi/service/PassengerOrderServiceTest.java`
- Modify: `order/src/main/java/com/sx/order/service/TripOrderSettlementService.java`
...
```bash
git add order passenger-api
git commit -m "feat: surface settlement progress in passenger orders"
```

---

### Task 13: 完整闭环验收、文档同步与最终验证

**Files:**

- Create: `docs/api/trip-order-settlement-api.md`
- Create: `docs/testing/trip-order-settlement-mock-runbook.md`
- Modify: `docs/superpowers/specs/2026-07-17-trip-order-settlement-design.md`
- Modify: `README.md`
...
Expected: 所有模块测试 PASS，输出无失败和错误。

Run: `rg -n "TODO_CONNECT_CHANNEL|amap-driving|Math\.random|finalAmount.*body|max\(BigDecimal\.ZERO\)|支付失败释放" map calculate order wallet passenger-api driver-api`

Expected: 不出现真实渠道占位、外部路线调用、随机 mock、读取司机金额、静默归零或支付失败释放券的生产代码命中。
...
git commit -m "test: verify complete trip settlement mock flow"
```
...
在宣称完成前，必须使用 `superpowers:verification-before-completion`，重新执行 Task 13 的完整测试与静态检索，并逐条核对设计文档第 16 节 33 个验收场景。任何失败都先修复后再报告；不得用“基本完成”代替验证结果。
