-- =============================================================================
-- passenger 库：建表（乘客 customer / AI 客服会话 / OAuth 绑定 / 后台 sys_*）
...
-- =============================================================================
-- AI 客服长期会话与消息。存量数据库建表使用 passenger_ai_conversation_patch.sql；
-- 已建消息表移除冗余 customer_id 使用 passenger_ai_message_drop_customer_id_patch.sql。
-- =============================================================================
