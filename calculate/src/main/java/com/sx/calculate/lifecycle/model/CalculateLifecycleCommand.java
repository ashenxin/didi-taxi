...
public record CalculateLifecycleCommand(
        String operationNo,
        String stepCode,
        long customerId,
    ...
    public CalculateLifecycleCommand {
    ...
    public ApplyCalculateLifecycleProjectionCommand toProjectionCommand() {
        return new ApplyCalculateLifecycleProjectionCommand(customerId, 0,
                targetLifecycleStatus, lifecycleVersion, operationNo, sourceEventId, requestedAt);
    }
}
