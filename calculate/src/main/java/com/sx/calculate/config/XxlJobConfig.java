...
public class XxlJobConfig {
    ...
    public XxlJobSpringExecutor xxlJobExecutor(XxlJobProperties properties) {
        if (properties.getAdmin() == null
            ...
            throw new IllegalStateException("xxl.job已开启，但calculate执行器配置不完整");
        }
        ...
        executor.setPort(executorProperties.getPort() > 0 ? executorProperties.getPort() : 9996);
    ...
    public static class Executor {
        private String appname = "calculate-executor";
